...
Abre <http://localhost:5173>. El navegador pedira permiso para la webcam. Por defecto, la app usa el backend HTTPS de AWS en `https://eggsofialucas.duckdns.org/api`.
...
```html
<script>window.EGG_API_URL = "https://eggsofialucas.duckdns.org/api";</script>
```
